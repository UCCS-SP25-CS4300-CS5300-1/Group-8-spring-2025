"""
Django settings for LeafQuest project.
...
if os.environ.get('DJANGO_SECRET_KEY'):
    ...
    SECRET_KEY = 'django-insecure-j^ai^3tq@ddx7t47&v*nzue#+c+6(8ud)tbiil8u58g*3to7+u'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'home.context_processors.client_preferences',
            ],
        },
    },
]

WSGI_APPLICATION = 'LeafQuest.wsgi.application'
