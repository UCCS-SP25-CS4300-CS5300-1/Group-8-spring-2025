...
chat_completion = client.chat.completions.create(
    messages=[
        ...
        {"role": "user", "content": f"Provide concise, actionable feedback in Markdown format, paying special attention to Django convention, security, and code efficiency for the following pull request equest diff:\n{diff}"}
    ],
    model="o3-mini"
)
